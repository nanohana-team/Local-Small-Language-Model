...
DEFAULT_SETTINGS: dict[str, Any] = {
    ...
    'pipeline': {
        ...
        'semantic_recall': {
            ...
            'axis_probe_limit': 256,
            'question_axis_probe_limit': 96,
            'explain_axis_probe_limit': 128,
            'respond_axis_probe_limit': 80,
            'relation_limit_per_seed': 6,
            'enable_domain_hint_boost': True,
            'domain_hint_bonus': 0.16,
            'domain_hint_probe_limit': 48,
        },
        'slot_filler': {
